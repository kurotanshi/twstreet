...
var map, marker, heading = 100, pitch = 1;
...
var imageReload = function(lat, lng){
  ...
  var sources = {
    photo: photo,
    stview: "https://maps.googleapis.com/maps/api/streetview?key="+ mapKey +"&size=740x860&location="+ lat +","+ lng +"&heading="+ heading +"&pitch=" + pitch
  };
...
function initMap() {
  ...
  map = new google.maps.Map(document.getElementById('map'), {
    zoom: 16,
    center: {lat: 25.04008086415386, lng: 121.51134886402133},
